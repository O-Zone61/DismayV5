...
#include "C:\HL-SDK\gmod\public\tier1\convar.h"

#include "../DColor.h"

typedef unsigned long IConVar;
typedef unsigned long IConsoleDisplayFunc;
typedef unsigned long ICvarQuery;
class CCvar
{
public:
	virtual void* CCvar::Connect(void * (*)(char  const*,int *)) = 0; = 0;
	...
	virtual void* CCvar::FactoryInternalIterator(void)
};
