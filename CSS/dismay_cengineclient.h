...
public:
	...
	virtual void* CEngineClient::GetPlayerInfo(int,player_info_s *) = 0;
	virtual void* CEngineClient::GetPlayerForUserID(int) = 0;
	virtual void* CEngineClient::TextMessageGet(char  const*) = 0;
	virtual void* CEngineClient::Con_IsVisible(void) = 0;
	virtual void* CEngineClient::GetLocalPlayer(void) = 0;
	...
	virtual void* CEngineClient::GetMaxClients(void) = 0;
	...
	virtual void* CEngineClient::CheckDoneKeyTrapping(ButtonCode_t &) = 0;
	virtual void* CEngineClient::IsInGame(void) = 0;
	virtual void* CEngineClient::IsConnected(void) = 0;
	...
	virtual void* CEngineClient::GetNetChannelInfo(void) = 0;
	...
	virtual void* CEngineClient::GetVideoModes(int &,vmode_s *&) = 0;
	...
	virtual void* CEngineClient::ServerCmdKeyValues(KeyValues *) = 0;
	...
	virtual void* CEngineClient::GetInstancesRunningCount(void) = 0;
