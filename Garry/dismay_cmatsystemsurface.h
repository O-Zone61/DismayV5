...
public:
	...
	virtual void* CMatSystemSurface::DrawFilledRectArray(void* /* vgui::IntRect * */ ,int) = 0;
	...
	virtual void* CMatSystemSurface::DrawPrintText(wchar_t  const*,int, void* /* vgui::FontDrawType_t */ ) = 0;
	virtual void* CMatSystemSurface::DrawUnicodeChar(wchar_t,void* /* vgui::FontDrawType_t */ ) = 0;
	virtual void* CMatSystemSurface::DrawFlushText(void) = 0;
	virtual void* CMatSystemSurface::CreateHTMLWindow(void* /* vgui::IHTMLEvents * */ ,uint) = 0;
	...
	virtual void* CMatSystemSurface::SupportsFeature(void* /* vgui::ISurface::SurfaceFeature_e */ ) = 0;
	...
	virtual ulong CMatSystemSurface::CreateFont(void) = 0;
	...
	virtual void* CMatSystemSurface::DrawTexturedLine(/* vgui::Vertex_t  const& */ void* ,/* vgui::Vertex_t  const& */ void*) = 0;
	virtual void* CMatSystemSurface::DrawOutlinedCircle(int,int,int,int) = 0;
	virtual void* CMatSystemSurface::DrawTexturedPolyLine(void* /* vgui::Vertex_t  const* */ ,int) = 0;
	virtual void* CMatSystemSurface::DrawTexturedSubRect(int,int,int,int,float,float,float,float) = 0;
	virtual void* CMatSystemSurface::DrawTexturedPolygon(int,void* /* vgui::Vertex_t * */,bool) = 0;
	...
	virtual void* CMatSystemSurface::DrawGetUnicodeCharRenderInfo(wchar_t,void* /* vgui::CharRenderInfo & */ ) = 0;
	virtual void* CMatSystemSurface::DrawRenderCharFromInfo(void* /* vgui::CharRenderInfo  const& */) = 0;
	...
	virtual void* CMatSystemSurface::DrawUnicodeString(wchar_t  const*,void* /* vgui::FontDrawType_t */) = 0;
	...
	virtual void* CMatSystemSurface::BHTMLWindowNeedsPaint(void* /* vgui::IHTML * */) = 0;
	...
	virtual void* CMatSystemSurface::GMOD_ClearFontCache(void) = 0;
	virtual void* CMatSystemSurface::GMOD_GetTextSize(ulong,wchar_t  const*,int &,int &) = 0;
	...
	virtual void* CMatSystemSurface::DrawPanelIn3DSpace(uint,void* /* VMatrix  const& */ ,int,int,float,float) = 0;
	virtual void* CMatSystemSurface::DrawSetTextureMaterial(int,void* /* IMaterial * */) = 0;
	...
	virtual CMatSystemSurface::~CMatSystemSurface() = 0;
	virtual void* CMatSystemSurface::InEngine(void) = 0;
	virtual void* CMatSystemSurface::IsInThink(uint) = 0;
};
#endif